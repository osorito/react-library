...
import { AddNewBook } from "./Components/AddnNewBook";
import { ChangeQuantityOfBooks } from "./Components/ChangeQuantityOfBooks";

export const ManageLibraryPage = () => {
  const { authState } = useOktaAuth();

  const [changeQuantityfBooksClick, setChangeQuantityOfBookClick] =
    useState(false);
  ...
  const changeQuantityOfBooksFunction = () => {
    ...
    <div className="container">
      <div className="mt-5">
        ...
        <div className="tab-content" id="nav-tabContent">
          ...
          >
            {changeQuantityfBooksClick ? <ChangeQuantityOfBooks /> : <></>}
          </div>
          <div
            className="tab-pane fade"
            id="nav-messages"
