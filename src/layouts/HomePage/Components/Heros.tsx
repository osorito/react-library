        ...
        <div className="row g-0 mt-5">
          ...
          <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
            <div className="m1-2">
              ...
              <p className="lead">
                The library team would like to know what you have been reading.
          ...
          <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
            <div className="ml-2">
              ...
              <p className="lead">
                ...
                possible for our Luv2Code read students! We are diligent about
                ouur book selection and our books are always going to be our top
                priority.
              </p>
            </div>
          </div>
          ...
          <div className="m-2">
            <div className="col-image-left">
              <div className="mt-2">
                <h1>What have you been reading?</h1>
                <p className="lead">
                  The library team would like to know what you have been
            ...
            <div className="m-2">
              ...
              <div className="mt-2">
                ...
                <p className="lead">
                  ...
                  work nonstop to provide the most accurate book selection
                  possible for our Luv2Code read students! We are diligent about
                  ouur book selection and our books are always going to be our
                  top priority.
                </p>
              </div>
            </div>
